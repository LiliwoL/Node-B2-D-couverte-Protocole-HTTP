...
function handleEtape4(res, method) {
    ...
    if (method !== 'POST') {
        ...
        response.next_step = 'Pour passer à l\'étape suivante, vous devez spécifier un type de contenu "application/json" dans votre requête POST à l\'URL "/5-content-type"  ';
